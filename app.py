...
#model= tf.keras.models.load_model(r'/home/brns/Desktop/ChestCXRProject/COVID-19/chestX-combined-97val.h5')
...
def about():
	#K.clear_session()	
	model= load_model(r'chestX-combined-97val.h5')
  ...
  #target_class1 = round(prediction[0][1]*100,2)
	target_class2 = round(prediction[0][1]*100,2)
	
	if target_class0 > target_class2:
		target = " Normal."
	else:
		target = " COVID-19 infected."  
	...
	return render_template("out.html",fname=fname,lname=lname,age=age,gender=gender,fever=fever,cough=cough,breathe=breathe,pain=pain,img=img,predict0=target_class0,predict2=target_class2, target = target)
